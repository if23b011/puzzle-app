...
@Component({
  selector: 'app-signup',
  standalone: true,
  imports: [MatFormFieldModule, MatInputModule, FormsModule, ReactiveFormsModule, MatButtonModule, MatIconModule, HttpClientModule],
...
export class SignupComponent {
  ...
  test() {
    console.log(this.getHelloWorld());
  }
  getHelloWorld() {
